...
local function process()
  ...
  if not fileExists(gridFileName) then
    SV:showMessageBox(SV:T("Error"), SV:T("Cannot open textGrid file").." '"..pitchFileName.."'"..SV:T("timing (<project_name>_TextGrid.txt) & pitch (<project_name>_Pitch.txt) files are expected to be in the project dir"))
    return
  end

  if not fileExists(pitchFileName) then
    SV:showMessageBox(SV:T("Error"), SV:T("Cannot open pitch file").." '"..pitchFileName.."'"..SV:T("timing (<project_name>_TextGrid.txt) & pitch (<project_name>_Pitch.txt) files are expected to be in the project dir"))
    return
  end
