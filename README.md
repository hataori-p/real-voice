...
Usually "tuning" a voice in vocal synthesizer means drawing some pitch curve over MIDI notes. The timing of the notes is seldom changed.
...
This way it also should sound better and it does - it is partly from a real person. I call it "Voice Copy". It is inaccurate, copied are only some prosodic features.

The scripts in this repository are designed to make the process easier.

## Installation
If you want to use these scripts, you have to have Dreamtonics Synthesizer V Studio Pro, which enables scripting.
...
After starting SynthV Studio you should have these scripts in the Scripts Menu:
- RV Load Envelope
- RV Load Pitch
- RV Quantize Pitch
- RV Split Note
